...
class ShowAlliancePage extends AbstractGamePage
{
	...
	function info()
	{
		...
		$this->assign(array(
			...
			'ally_description' 				=> RichTextService::render($this->allianceData['ally_description']),
	...
	function apply()
	{
		...
		$text		= RichTextService::prepareForStorage((string) ($_POST['text'] ?? ''));
		$allianceId	= HTTP::_GP('id', 0);
		...
		$this->assign(array(
			'allyid'			=> $allianceId,
			'applytext'			=> RichTextService::render($allianceResult['ally_request']),
	...
	private function homeAlliance()
	{
		...
		$this->assign(array(
			...
			'ally_image'				=> $this->allianceData['ally_image'],
			'ally_description'			=> RichTextService::render($this->allianceData['ally_description']),
			'ally_text' 				=> RichTextService::render($this->allianceData['ally_text']),
			'rankName'					=> $rankName,
	...
	protected function adminOverview()
	{
		...
		$this->assign(array(
			...
			'textMode' 					=> $textMode,
			'text' 						=> RichTextService::render($text),
			'ally_tag' 					=> $this->allianceData['ally_tag'],
			'ally_name'					=> $this->allianceData['ally_name'],
			'ally_web' 					=> $this->allianceData['ally_web'],
			'ally_image'				=> $this->allianceData['ally_image'],
	...
	protected function adminDetailApply()
	{
		...
		$applyDetail['text']    	= RichTextService::render($applyDetail['text']);
