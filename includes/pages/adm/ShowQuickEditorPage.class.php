...
class ShowQuickEditorPage extends AbstractAdminPage
{
	...
	function player(){
		...
		if (empty($PlanetInfo)) {
			$this->printMessage('La planète principale du joueur est introuvable.');
		}
	...
	function planet(){
		...
		if (empty($PlanetData)) {
			$this->printMessage('La planète demandée est introuvable.');
		}
		...
		if (empty($UserInfo)) {
			$this->printMessage('Le propriétaire de cette planète est introuvable.');
		}
