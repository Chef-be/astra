...
class ShowVertifyPage extends AbstractAdminPage
{
  ...
  function check(){
    ...
    curl_setopt($ch, CURLOPT_URL, 'https://raw.githubusercontent.com/ultimateXnova/ultimateXnova/master/'.$file);
    curl_setopt($ch, CURLOPT_HEADER, false);
    curl_setopt($ch, CURLOPT_USERAGENT, "Astra Dominion Update API");
