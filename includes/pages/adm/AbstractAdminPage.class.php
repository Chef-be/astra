...
abstract class AbstractAdminPage
{
	...
	protected function getPageData()
	{
		...
		$pageTitle = $this->tplObj->getTemplateVars('title');
		$currentPage = HTTP::_GP('page','');
		$currentSearch = HTTP::_GP('search','');
		$pageMeta = AdminUiService::getPageMeta($currentPage, $currentSearch);
		if (empty($pageTitle)) {
		...
		$this->assign(array(
			...
			'sid'					=> session_id(),
			'id'					=> $USER['id'],
			'gameName'				=> Config::get(Universe::getEmulated())->game_name,
