...
<table class="table table-gow table-sm fs-12">
	...
	{/if}
	<tr>
		<td colspan="2" style="height:100px" class="bbcode rich-content">{if $ally_description}{$ally_description nofilter}{else}{$LNG.al_description_message}{/if}</td>
	</tr>
	{if $ally_web}
	<tr>
	...
	<tr>
		<td colspan="2" height="100" class="bbcode rich-content">{$ally_text nofilter}</td>
	</tr>
	<tr>
