...
<table class="table table-gow">
	...
	<tr>
		<td colspan="2">
			...
			{if $answerRow@first}
			<span class="fs-14 color-blue fw-bold">
					{$LNG.ti_category}: {$categoryList[$answerRow.categoryID]|default:'-'}
			</span>
			<br>
			{/if}
			<hr>
			<div class="fs-14 text-white rich-content">
				{$answerRow.message nofilter}
			</div>
		</td>
	</tr>
		{/foreach}
		...
		<tr>
			...
			<td style="width:70%"><textarea class="validate[required] form-control bg-dark text-white rich-editor" id="message" name="message" rows="60" cols="8" style="height:100px;"></textarea></td>
		</tr>
		<tr>
