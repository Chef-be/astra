...
{block name="content"}
	...
	<tr>
		<td colspan="4"><div class="rich-content">{$applyDetail.text nofilter}</div></td>
	</tr>
	{/if}
	</table>
<br>
...
<table class="table table-sm fs-12 table-gow">
	...
	<tr>
		<td colspan="4">
			<textarea name="text" rows="10" class="rich-editor bg-dark text-white w-100 fs-12" id="message"></textarea>
		</td>
	</tr>
	<tr>
