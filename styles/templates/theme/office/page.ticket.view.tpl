...
<table class="table519">
	...
	<tr>
		<td class="left" colspan="2">
			...
			{if $answerRow@first}
				<br>{$LNG.ti_category}: {$categoryList[$answerRow.categoryID]|default:'-'}
			{/if}
			<hr>
	...
	<tr>
		...
		<td style="width:70%"><textarea class="validate[required] rich-editor" id="message" name="message" rows="60" cols="8" style="height:100px;"></textarea></td>
	</tr>
	<tr>
