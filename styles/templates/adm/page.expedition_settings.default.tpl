	...
	<form class="admin-stack" action="admin.php?page=expedition&amp;mode=send" method="post">
		...
		<div class="admin-table-shell admin-stack">
			<div>
				...
				<p class="text-white-50 mb-0">Modifiez le volume des gains générés pour les expéditions récompensantes.</p>
			</div>
		...
		<div class="admin-table-shell admin-stack">
			<div>
				...
				<p class="text-white-50 mb-0">Réglez les chances de rencontrer chaque type d’issue.</p>
			</div>
			<div class="admin-form-grid">
