...
<div class="admin-section-nav">
	...
	<a class="admin-section-link" href="#universe-referral">Parrainage</a>
	<a class="admin-section-link" href="#universe-colonies">Colonisation</a>
	<a class="admin-section-link" href="#universe-planets">Planètes</a>
	<a class="admin-section-link" href="#universe-rules">Règles</a>
...
<div id="universe-general" class="form-gorup d-flex flex-column my-1 p-2 admin-section-title">
	<span class="text-yellow fw-bold fs-14">Identité et cadence de l’univers</span>
	<small>Nom, langue, vitesses de jeu, disponibilité des éléments et état d’ouverture.</small>
</div>
...
<div id="universe-build" class="form-gorup d-flex flex-column my-1 p-2 admin-section-title">
	<span class="text-yellow fw-bold fs-14">{$LNG.se_buildlist}</span>
	<small>Limites des files de construction, recherche et chantier.</small>
</div>
<div class="form-gorup d-flex flex-column my-1 p-2 ">
...
<div id="universe-referral" class="form-gorup d-flex flex-column my-1 p-2 admin-section-title">
...
<div id="universe-colonies" class="form-gorup d-flex flex-column my-1 p-2 admin-section-title">
	<span class="text-yellow fw-bold fs-14">{$LNG.se_server_colonisation_config}</span>
	<small>Nombre de colonies, progression et contraintes associées.</small>
</div>
<div class="form-gorup d-flex flex-column my-1 p-2 ">
...
<div id="universe-planets" class="form-gorup d-flex flex-column my-1 p-2 admin-section-title">
	...
	<small>Paramètres initiaux des planètes, économie et coûts structurels.</small>
</div>
<div class="form-gorup d-flex flex-column my-1 p-2 ">
...
<div id="universe-rules" class="form-gorup d-flex flex-column my-1 p-2 admin-section-title">
	<span class="text-yellow fw-bold fs-14">{$LNG.se_several_parameters}</span>
	<small>Règles avancées de l’univers, protection, débris, portes et limites.</small>
</div>
<div class="form-gorup d-flex flex-column my-1 p-2 ">
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label class="text-start my-1 cursor-pointer hover-underline" for="user_max_notes">Nombre maximal de notes par joueur</label>
...
<div id="universe-trader" class="form-gorup d-flex flex-column my-1 p-2 admin-section-title">
...
<div id="universe-news" class="form-gorup d-flex flex-column my-1 p-2 admin-section-title">
