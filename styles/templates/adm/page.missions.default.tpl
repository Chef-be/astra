{block name="content"}
<div class="container-fluid py-4 text-white admin-stack admin-missions-page">
			...
			<details class="admin-fold admin-fold--compact">
				<summary class="admin-fold__summary">
					<div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
						<div>
							<h2 class="h5 mb-1">Nouvelle mission</h2>
							<p class="text-white-50 mb-0">Assistant de création complet, replié par défaut sur mobile.</p>
						</div>
						<span class="admin-pill">Création</span>
					</div>
				</summary>
				...
				<summary class="admin-fold__summary">
					<div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
						<div>
							...
							<p class="text-white-50 mb-0">Définitions existantes, repliées par défaut pour laisser l’accès rapide aux compteurs et à la synchronisation.</p>
						</div>
